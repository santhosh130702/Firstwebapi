...
namespace Firstwebapi.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        //            Title = emp.Title,
        //            City = emp.City,
        //            ReportsTo= newEmployee.ReportsTo>0? newEmployee.ReportsTo }
        ...
        public int AddEmployee(EmpViewModel newemp)
        {
           ...
           int result= _repositoryEmployee.AddEmployee(employee);
            return result;
        }

        ////public int EditEmployee(int id, [FromBody] Employee updatedEmployee)
        ////{
        ...
        ////    var savedEmployee = _repositoryEmployee.UpdateEmployee(updatedEmployee);
